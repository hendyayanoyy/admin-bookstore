...
// Mengambil data member dari tabel memebers
    ...
    <div class="fixed flex flex-col top-0 left-0 w-64 bg-indigo-100 h-full border-r">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <ul class="flex flex-col py-4 space-y-1">
                ...
                <!-- Members -->
                <li>
                    <a href="panel_members.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-indigo-50 text-gray-600 hover:text-indigo-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                        <span class="inline-flex justify-center items-center ml-4">
                            <i class="fas fa-receipt"></i>
                        </span>
                        <span class="ml-2 text-sm tracking-wide truncate">Members</span>
                        <span class="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-green-500 bg-green-50 rounded-full"><?php echo $totalMembers; ?></span>
